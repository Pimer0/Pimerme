...
<nav className='m-4 flex place-self-end'>
    <Link className="text-zinc-100 m-4" to="/">Acceuil</Link>
    <Link className="text-zinc-100 m-4" to="/Profile">Profile</Link>
    <Link className="text-zinc-100 m-4" to="/Rs">Rs</Link>
</nav>
